                                                  ...
                                                  children: [
                                                    for (int j = 0; j < (controller.practiceResult.value?.script?[index].sentences?.length ?? 0); j++)
                                                      (controller.practiceResult.value?.script?[index].sentences?[j].sentenceContent == null ||
                                                          ...
                                                          ? TextSpan(
                                                              text: "빈 문장 ", style: const TextStyle(color: Colors.grey), recognizer: TapGestureRecognizer()
                                                              // 결과 수정 기능 비활성화
                                                              // ..onTap = () {
                                                              //   showDialog(
                                                              //       context: context,
                                                              ...
                                                              //                     .practiceResult.value?.script?[index].sentences?[j].sentenceContent ??
                                                              //                 "",
                  ...
                  Expanded(
                    child: ColoredButton(
                      ...
                      onPressed: () {
                        ...
                        // 수정하기 기능 비활성화에 따른 수정사항 반영하기 팝업 비활성화
