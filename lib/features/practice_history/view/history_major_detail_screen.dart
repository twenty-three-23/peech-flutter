...
class HistoryMajorDetailScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    HistoryMajorModel? major =
        controller.majorList.value?.majorScripts?.firstWhereOrNull((element) => element.majorVersion == controller.historyPath.value.major);
                    ...
                    Expanded(
                      child: Padding(
                        ...
                        child: ListView(children: [
                          ...
                          Align(alignment: Alignment.topLeft, child: Text("날짜: ${major?.createdAt ?? "unknown"}")),
                          const SizedBox(
                            height: 10,
                          ),
