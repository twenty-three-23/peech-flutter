...
*/
  ...
  void Function()? onStartPlayerPressed() {
    ...
    if (_media == Media.file || _media == Media.stream || _media == Media.buffer) // A file must be already recorded to play it
    {
  ...
  AssetImage recorderAssetImage() {
    ...
    return (recorderModule.isStopped) ? const AssetImage('res/icons/ic_mic.png') : const AssetImage('res/icons/ic_stop.png');
  }
    ...
    Widget recorderSection = Column(crossAxisAlignment: CrossAxisAlignment.center, mainAxisAlignment: MainAxisAlignment.center, children: <Widget>[
      ...
      _isRecording
          ? LinearProgressIndicator(
              value: 100.0 / 160.0 * (_dbLevel ?? 1) / 100, valueColor: const AlwaysStoppedAnimation<Color>(Colors.green), backgroundColor: Colors.red)
          : Container(),
      Row(
        mainAxisAlignment: MainAxisAlignment.center,
        crossAxisAlignment: CrossAxisAlignment.center,
